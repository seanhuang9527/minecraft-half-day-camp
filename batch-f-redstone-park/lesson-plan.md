...
| --- | --- | --- | --- |
| 低階 | 紅石燈排列機器人 | 完成九格排列並正確放置紅石火把 | 紅石電路驗收 |
| 中階 | 紅石方塊辨識機器人 | 只挖除目標紅石方塊 | 紅石巡邏辨識賽 |
| 高階 | 雙向分類巡邏機器人 | 目標被挖除，非目標旁有分類標記 | 進階分類挑戰 |
...
- 上述座標來自舊版執行畫面，只作為找場地的參考；正式使用神木村 v8 時，老師需重新確認地形與 Agent 面向。
