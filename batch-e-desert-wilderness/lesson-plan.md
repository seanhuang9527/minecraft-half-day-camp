...
| --- | --- | --- | --- |
| 低階 | 單點挖沙機器人 | 完成單一挖掘點並取得足夠沙子 | 玻璃製作挑戰 |
| 中階 | 雙點挖沙機器人 | 完成兩個挖掘點並收集材料 | 染色玻璃建造挑戰 |
| 高階 | 自動建造玻璃空中橋 | 完成 3 格寬、12 排長且無缺口的橋面 | 天空之城建造賽 |
...
- 正式使用神木村 v8 時，老師必須重新確認該位置是否仍為足夠厚的沙地，不可直接把舊座標當成固定起點。
